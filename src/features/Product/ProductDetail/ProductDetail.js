                                        ...
                                        <div className="shop-product">
                                              <div className="row pb-100">
                                                    <div className="col-lg-6 mb-md-70 mb-sm-70">
                                                          ...
                                                          <div
                                                              className="shop-product__big-image-gallery-wrapper mb-30">
                                                                {/*=======  shop product gallery icons  =======*/}
                                                                <div
                                                                    className="single-product__floating-badges single-product__floating-badges--shop-product">
                      ...
                      <a className="btn-zoom-popup" href="#" data-tippy="Click to enlarge" data-tippy-placement="left"
                         ...
                         data-tippy-arrow="true" data-tippy-theme="sharpborder"><i className="ion-android-expand"/></a>
                                                          ...
                                                          <div className="shop-product__small-image-gallery-wrapper">
                                                                <div
                                                                    className="shop-product__small-image-gallery-slider">
                                                                      {/*=======  single image  =======*/}
                                                                      <div className="single-image">
                                                                            <img
                                                                                src="assets/images/shop-product/soccer-1-100x100.png"
                                                                                className="img-fluid" alt=""/>
                                                                      </div>
                                                                      {/*=======  End of single image  =======*/}
                                                                      {/*=======  single image  =======*/}
                                                                      <div className="single-image">
                                                                            <img
                                                                                src="assets/images/shop-product/soccer-2-100x100.png"
                                                                                className="img-fluid" alt=""/>
                                                                      </div>
                                                                      {/*=======  End of single image  =======*/}
                                                                      {/*=======  single image  =======*/}
                                                                      <div className="single-image">
                                                                            <img
                                                                                src="assets/images/shop-product/soccer-3-100x100.png"
                                                                                className="img-fluid" alt=""/>
                                                                      </div>
                                                                      {/*=======  End of single image  =======*/}
                                                                      {/*=======  single image  =======*/}
                                                                      <div className="single-image">
                                                                            <img
                                                                                src="assets/images/shop-product/soccer-4-100x100.jpg"
                                                                                className="img-fluid" alt=""/>
                                                                      </div>
                                                                      {/*=======  End of single image  =======*/}
                                                                      {/*=======  single image  =======*/}
                                                                      <div className="single-image">
                                                                            <img
                                                                                src="assets/images/shop-product/soccer-5-100x100.png"
                                                                                className="img-fluid" alt=""/>
                                                                      </div>
                                                                      {/*=======  End of single image  =======*/}
                                                                      {/*=======  single image  =======*/}
                                                                      <div className="single-image">
                                                                            <img
                                                                                src="assets/images/shop-product/trendcoat-1-100x100.jpg"
                                                                                className="img-fluid" alt=""/>
                                                                      </div>
                                                                      {/*=======  End of single image  =======*/}
                                                                      {/*=======  single image  =======*/}
                                                                      <div className="single-image">
                                                                            <img
                                                                                src="assets/images/shop-product/trendcoat-2-100x100.jpg"
                                                                                className="img-fluid" alt=""/>
                                                                      </div>
                                                                      {/*=======  End of single image  =======*/}
                                                                </div>
                    ...
                    <span className="product-rating">
                      ...
                      <a href="#">(3 customer reviews)</a>
                                                                ...
                                                                <div className="shop-product__price mb-30">
                                                                      <span
                                                                          className="main-price discounted">$160.00</span>
                                                                ...
                                                                <div className="shop-product__short-desc mb-50">
                                                                      ...
                                                                      you
                                                                      dry and comfortable. Made with sweat-wicking
                                                                      fabric. Fitted waist with belt loops. Button waist
                                                                      with
                                                                      zip fly provides a classic look and feel . Back
                                                                      welt pockets and coin pocket for storage. Dual
                                                                      side
                                                                      seam pockets. Heat transferred logos. 70% nylon
                                                                      24% polyester 6% spandex. Imported.
                                                                </div>
                                                                {/*=======  End of shop product short description  =======*/}
                                                                {/*=======  shop product size block  =======*/}
                                                                <div
                                                                    className="shop-product__block shop-product__block--size mb-20">
                                                                      <div
                                                                          className="shop-product__block__title">Size:
                                                                      </div>
                                                                ...
                                                                <div
                                                                    className="shop-product__block shop-product__block--color mb-20">
                                                                      <div
                                                                          className="shop-product__block__title">Color:
                                                                      </div>
                                                                      <div className="shop-product__block__value">
                                                                ...
                                                                <div
                                                                    className="shop-product__block shop-product__block--quantity mb-40">
                                                                      <div
                                                                          className="shop-product__block__title">Quantity:
                                                                      </div>
                                                                      <div className="shop-product__block__value">
                                                                            <div
                                                                                className="pro-qty d-inline-block mx-0 pt-0">
                                                                ...
                                                                <div className="quick-view-other-info pb-0">
                                                                      <table>
                                                                            ...
                                                                            <tr className="single-info">
                                                                                  <td className="quickview-title">Share
                                                                                        on:
                                                                                  </td>
                                                                                  <td className="quickview-value">
                                              ...
                                              <div className="row">
                                                    <div className="col-lg-12">
                                                          ...
                                                          <div className="shop-product__description-tab pt-100">
                                                                {/*=======  tab navigation  =======*/}
                                                                <div
                                                                    className="tab-product-navigation tab-product-navigation--product-desc mb-50">
                                                                      <div
                                                                ...
                                                                <div className="tab-content" id="nav-tabContent2">
                                                                      <div className="tab-pane fade show active"
                                                                           id="product-series-1" role="tabpanel"
                                                                           aria-labelledby="product-tab-1">
                                                                            {/*=======  shop product long description  =======*/}
                                                                            <div
                                                                                className="shop-product__long-desc mb-30">
                                                                                  <p>Hurley Dry-Fit Chino Short. Men’s
                                                                                        chino short. Outseam Length: 19
                                                                                        ...
                                                                                        . Back welt pockets and coin
                                                                                        pocket
                                                                                        for storage. Dual side seam
                                                                                        pockets. Heat transferred logos.
                                                                                        70% nylon 24% polyester 6%
                                                                                        spandex. Imported.</p>
                                                                            </div>
                                                                            {/*=======  End of shop product long description  =======*/}
                                                                      </div>
                                                                      <div className="tab-pane fade"
                                                                           id="product-series-2" role="tabpanel"
                                                                           aria-labelledby="product-tab-2">
                                                                            {/*=======  shop product additional information  =======*/}
                                                                            <div
                                                                                className="shop-product__additional-info">
                                                                      ...
                                                                      <div className="tab-pane fade"
                                                                           id="product-series-3" role="tabpanel"
                                                                           aria-labelledby="product-tab-3">
                                                                            {/*=======  shop product reviews  =======*/}
                                                                            <div className="shop-product__review">
                                                                                  <h2 className="review-title mb-20">3
                                                                                        reviews for High-waist
                                                                                        Trousers</h2>
                                                                                  {/*=======  single review  =======*/}
                                                                                  <div className="single-review">
                                                                                        ...
                                                                                        <div
                                                                                            className="single-review__content">
                                                                                              {/*=======  rating  =======*/}
                                                                                              <div
                                                                                                  className="shop-product__rating">
                              <span className="product-rating">
                                <i className="active ion-android-star"/>
                                <i className="active ion-android-star"/>
                                <i className="active ion-android-star"/>
                                ...
                                <i className="ion-android-star-outline"/>
                                                                                              ...
                                                                                              {/*=======  End of rating  =======*/}
                                                                                              {/*=======  username and date  =======*/}
                                                                                              <p className="username">Scott
                                                                                                    James <span
                                                                                                        className="date">/ April 5, 2018</span>
                                                                                              </p>
                              ...
                              <span className="product-rating">
                                ...
                                <i className="ion-android-star-outline"/>
                                                                                              ...
                                                                                              {/*=======  End of rating  =======*/}
                                                                                              {/*=======  username and date  =======*/}
                                                                                              <p className="username">Owen
                                                                                                    Christ <span
                                                                                                        className="date">/ April 7, 2018</span>
                                                                                              </p>
                                                                                              {/*=======  End of username and date  =======*/}
                                                                                              {/*=======  message  =======*/}
                                                                                              <p className="message">
                                                                                  ...
                                                                                  {/*=======  End of single review  =======*/}
                                                                                  <h2 className="review-title mb-20">Add
                                                                                        a review</h2>
                                                                                  <p className="text-center">Your email
                                                                                        address will not be published.
                                                                                        Required fields are marked *
                                                                                  </p>
                                                                                  {/*=======  review form  =======*/}
                                                                                  <div
                                                                                      className="lezada-form lezada-form--review">
                                                                                        <form action="#">
                                                                                              <div className="row">
                                                                                                    <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        className="col-lg-12 mb-20">
                                                                                                          <span
                                                                                                              className="rating-title mr-30">YOUR RATING</span>
                                                                                                          <span
                                                                                                              className="product-rating">
                                                                                                    ...
                                                                                                    <div
                                                                                                        className="col-lg-12 text-center">
                                                                                                          <button
                                                                                                              type="submit"
                                                                                                              className="lezada-button lezada-button--medium">submit
                                                                                                          </button>
                                                                                                    </div>
                                                                                              </div>
                                                                                        </form>
